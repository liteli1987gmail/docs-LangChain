...
本指南解释如何为您的部署的跨线程[存储](/oss/python/langgraph/persistence#memory-store)添加语义搜索，以便您的代理可以按语义相似性搜索记忆和其他文档。
...
配置后，您可以在您的[节点](/oss/python/langgraph/graph-api#nodes)中使用语义搜索。存储需要命名空间元组来组织记忆：
