...
> [Pebblo](https://daxa-ai.github.io/pebblo/) 使开发者能够安全地加载数据，并在不担心组织合规性和安全要求的情况下将 Gen AI 应用推向部署。该项目能够识别加载数据中的语义主题和实体，并在 UI 或 PDF 报告中进行总结。
...
> 注意：_Pebblo Entity Classifier_ 能有效识别个人信息（PII），并持续演进。虽然其召回率尚未达到 100%，但正在稳步提升。
>
> 更多详细信息，请参阅 [_Pebblo Entity Classifier 文档_](https://daxa-ai.github.io/pebblo/entityclassifier/)。
