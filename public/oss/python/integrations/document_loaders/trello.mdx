...
[Trello](https://www.atlassian.com/software/trello) 是一款基于网页的项目管理和协作工具，允许个人和团队组织并跟踪他们的任务和项目。它提供了一个名为“看板”的视觉界面，用户可以在其中创建列表和卡片来表示任务和活动。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\document_loaders\trello.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
