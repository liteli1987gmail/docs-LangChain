...
>[Azure OpenAI Whisper Parser](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/whisper-overview) 是 Azure OpenAI Whisper API 的封装，利用 machine learning 将音频文件转录为英文文本。

>该 Parser 支持 `.mp3`、`.mp4`、`.mpeg`、`.mpga`、`.m4a`、`.wav` 和 `.webm` 格式。
