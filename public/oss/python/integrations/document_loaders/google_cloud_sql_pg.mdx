...
[Cloud SQL for PostgreSQL](https://cloud.google.com/sql/docs/postgres) 是一个完全托管的数据库服务，帮助您在 Google Cloud Platform 上设置、维护、管理和运营 PostgreSQL 关系型数据库。通过 Cloud SQL for PostgreSQL 与 LangChain 的集成，扩展您的数据库应用程序，构建 AI 驱动的体验。
