...
For detailed documentation of all `JSONLoader` features and configurations head to the [接口 reference](https://reference.langchain.com/python/langchain-community/document_loaders/json_loader/JSONLoader)
