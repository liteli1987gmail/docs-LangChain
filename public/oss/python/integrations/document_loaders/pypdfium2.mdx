...
For detailed documentation of all `PyPDFium2Loader` features and configurations head to the [接口 reference](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/PyPDFium2Loader)
