...
For detailed documentation of all `BSHTMLLoader` features and configurations head to the [接口 reference](https://reference.langchain.com/python/langchain-community/document_loaders/html_bs/BSHTMLLoader)
