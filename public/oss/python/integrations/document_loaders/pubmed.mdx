...
由美国国家生物技术信息中心（NCBI）和美国国家医学图书馆（NLM）提供的 [PubMed®](https://pubmed.ncbi.nlm.nih.gov/) 收录了超过 3500 万条生物医学文献引文，这些文献来自 MEDLINE、生命科学期刊和在线图书。引文可能包含指向 PubMed Central 和出版商网站的全文内容链接。
