...
Browse the [接口 documentation](https://soniox.com/docs/stt/api-reference/transcriptions/create_transcription) for a full list of supported options.
...
Learn more about the [Soniox 接口 reference](https://soniox.com/docs/stt/api-reference/transcriptions/get_transcription_transcript).

## Related

- [Soniox 接口 documentation](https://soniox.com/docs)
