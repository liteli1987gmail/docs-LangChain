...
TSV（制表符分隔值）文件是一种用于存储表格数据的简单文本文件格式。[3] 记录之间以换行符分隔，同一记录中的值则以制表符分隔。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\document_loaders\tsv.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
