...
[RecursiveCharacterTextSplitter](https://reference.langchain.com/python/langchain-text-splitters/character/RecursiveCharacterTextSplitter) 包含预建的分隔符列表，对[分割特定编程语言中的文本](/oss/python/integrations/splitters/)很有用。
