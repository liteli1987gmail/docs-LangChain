...
[PubMed®](https://pubmed.ncbi.nlm.nih.gov/) 包含超过 3500 万条来自 MEDLINE、生命科学期刊和在线书籍的生物医学文献引用。这些引用可能包含指向 PubMed Central 和出版商网站的全文内容链接。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\pubmed.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
