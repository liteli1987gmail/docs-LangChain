...
>
>DataForSeo API 从 Google、Bing、Yahoo 等最受欢迎的搜索引擎检索 SERP。它还能获取来自不同搜索引擎类型（如 Maps、News、Events 等）的 SERP。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\dataforseo.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
