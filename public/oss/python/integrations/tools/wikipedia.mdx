...
[维基百科](https://wikipedia.org/)是一部多语言免费在线百科全书，由被称为维基人的志愿者社区通过开放式协作编写和维护，使用名为 MediaWiki 的基于 wiki 的编辑系统。维基百科是有史以来最大、最受欢迎的参考作品。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\wikipedia.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
