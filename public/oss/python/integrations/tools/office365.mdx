...
[Microsoft 365](https://www.office.com/) 是一个由 `Microsoft` 拥有的生产力软件、协作和基于云的服务的产品系列。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\office365.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
