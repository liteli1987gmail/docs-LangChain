...
[Wikidata](https://wikidata.org/) 是一个免费且开放的知识库，人类和机器都可以阅读和编辑。Wikidata 是世界上最大的开放知识库之一。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\wikidata.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
