---
title: "Riza code interpreter integration"
description: "Integrate with the Riza code interpreter tool using LangChain Python."
---

Riza Code Interpreter 是一个基于 WASM 的隔离环境，用于运行 AI agents 生成的 Python 或 JavaScript 代码。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\riza.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
