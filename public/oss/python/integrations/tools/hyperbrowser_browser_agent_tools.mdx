...
- [Browser Use 接口 Reference](https://docs.hyperbrowser.ai/reference/api-reference/agents/browser-use)
- [OpenAI CUA 接口 Reference](https://docs.hyperbrowser.ai/reference/api-reference/agents/openai-cua)
- [Claude Computer Use 接口 Reference](https://docs.hyperbrowser.ai/reference/api-reference/agents/claude-computer-use)
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\hyperbrowser_browser_agent_tools.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
