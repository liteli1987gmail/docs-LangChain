...
Lemon Agent 帮助你快速构建强大的 AI 助手，并通过在 Airtable、Hubspot、Discord、Notion、Slack 和 GitHub 等工具中实现准确可靠的读写操作来自动化工作流程。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\lemonai.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
