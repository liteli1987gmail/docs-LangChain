...
您好！我已了解翻译要求：将英文翻译为中文，同时保留网址和技术术语（如 LangChain、LLM、API 等）的英文原名。

不过，您似乎还没有提供需要翻译的具体文本。请发送您想要翻译成中文的英文内容，我会为您进行翻译。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\writer.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
