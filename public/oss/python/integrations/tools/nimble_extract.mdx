...
[Nimble's Extract API](https://docs.nimbleway.com/nimble-sdk/extract-api) 通过无头浏览器浏览指定 URL 来提取渲染后的内容。与发现内容的 search APIs 不同，Extract 工具处理已知 URL——非常适合需要获取和处理特定网页的 agent workflows，包括分页、过滤器和客户端渲染背后的内容。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\nimble_extract.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
