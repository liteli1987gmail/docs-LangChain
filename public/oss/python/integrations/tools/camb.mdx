...
For detailed documentation of all CAMB AI features and configurations, head to the [CAMB AI 接口 reference](https://docs.camb.ai).
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\camb.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
