...
[Alpha Vantage](https://www.alphavantage.co) Alpha Vantage 通过一套功能强大且对开发者友好的 Data API 和电子表格，提供实时和历史金融市场数据。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\alpha_vantage.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
