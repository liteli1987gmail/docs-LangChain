...
[Valyu](https://www.valyu.network/) 使 AI 应用和 agent 能够搜索互联网和专有数据源，获取相关的 LLM 可用信息。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\valyu_search.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
