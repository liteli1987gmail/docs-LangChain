...
This guide provides a quick overview for getting started with ScrapeGraph [tools](/oss/python/integrations/tools/). For detailed documentation of all ScrapeGraph features and configurations head to the [接口 reference](https://python.langchain.com/docs/integrations/tools/scrapegraph).
...
For detailed documentation of all ScrapeGraph features and configurations head to [the LangChain 接口 reference](https://python.langchain.com/docs/integrations/tools/scrapegraph).
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\scrapegraph.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
