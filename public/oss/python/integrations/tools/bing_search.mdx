...
[Bing Search](https://learn.microsoft.com/en-us/bing/search-apis/bing-web-search/) 是一项 Azure 服务，支持安全、无广告、位置感知的搜索结果，可从数十亿份网络文档中呈现相关信息。通过利用 Bing 的强大能力，帮助您的用户在全球互联网上找到他们所需的信息，只需一次 API 调用即可搜索数十亿的网页、图片、视频和新闻。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\tools\bing_search.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
