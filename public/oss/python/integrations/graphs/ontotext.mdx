...
[Ontotext GraphDB](https://graphdb.ontotext.com/) 是一个图数据库和知识发现工具，符合 [RDF](https://www.w3.org/RDF/) 和 [SPARQL](https://www.w3.org/TR/sparql11-query/) 标准。


本笔记本展示了如何使用 LLM 提供自然语言查询（NLQ 到 SPARQL，也称为 `text2sparql`），用于 `Ontotext GraphDB`。
