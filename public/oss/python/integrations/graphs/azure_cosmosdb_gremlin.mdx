...
[Azure Cosmos DB for Apache Gremlin](https://learn.microsoft.com/en-us/azure/cosmos-db/gremlin/introduction) 是一个图数据库服务，可用于存储包含数十亿顶点和边的海量图。您可以毫秒级延迟查询图，并轻松演化图结构。
