...
This will help you get started with Netmind [chat models](https://www.netmind.ai/). For detailed documentation of all `ChatNetmind` features and configurations head to the [接口 reference](https://github.com/protagolabs/langchain-netmind).
