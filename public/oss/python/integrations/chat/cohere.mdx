...
Head to the [接口 reference](https://reference.langchain.com/python/langchain-cohere/chat_models/ChatCohere) for detailed documentation of all attributes and methods.
...
We'll also need to get a [Cohere 接口 key](https://cohere.com/) and set the `COHERE_API_KEY` environment variable:
