...
This will help you get started with Qwen [chat models](/oss/python/langchain/models). For detailed documentation of all `ChatQwen` features and configurations head to the [接口 reference](https://pypi.org/project/langchain-qwq/).
...
Head to [Alibaba's 接口 Key page](https://account.alibabacloud.com/login/login.htm?oauth_callback=https%3A%2F%2Fbailian.console.alibabacloud.com%2F%3FapiKey%3D1&lang=en#/api-key) to sign up to Alibaba Cloud and generate an API key. Once you've done this set the `DASHSCOPE_API_KEY` environment variable:
...
For detailed documentation of all `ChatQwen` features and configurations head to the [接口 reference](https://pypi.org/project/langchain-qwq/)
