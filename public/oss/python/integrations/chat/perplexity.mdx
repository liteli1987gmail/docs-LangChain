...
This page will help you get started with Perplexity [chat models](/oss/python/langchain/models). For detailed documentation of all `ChatPerplexity` features and configurations head to the [接口 reference](https://reference.langchain.com/python/langchain-perplexity/chat_models/ChatPerplexity).
