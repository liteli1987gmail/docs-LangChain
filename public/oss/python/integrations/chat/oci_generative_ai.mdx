...
For detailed documentation, see the [OCI Generative AI documentation](https://docs.oracle.com/en-us/iaas/Content/generative-ai/home.htm) and [接口 reference](https://docs.oracle.com/en-us/iaas/api/#/en/generative-ai/20231130/).
...
For detailed documentation of all `ChatOCIGenAI` features and configurations, head to the [接口 reference](https://github.com/oracle/langchain-oracle/tree/main/libs/oci).
...
- [工具 Calling Guide](/oss/python/langchain/tools/)
