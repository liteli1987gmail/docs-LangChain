...
[GLM-4](https://open.bigmodel.cn/) 是一个多语言 LLM，与人类意图对齐，具有问答、多轮对话和代码生成能力。新一代基座模型 GLM-4 的整体性能相比上一代有了显著提升，支持更长的上下文；更强的多模态能力；支持更快的推理速度、更高的并发，大大降低了推理成本；同时，GLM-4 增强了智能体的能力。
