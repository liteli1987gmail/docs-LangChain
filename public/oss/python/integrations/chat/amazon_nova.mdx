...
To access Amazon Nova models, you'll need to [obtain 接口 credentials](https://nova.amazon.com/dev) and install the [`langchain-amazon-nova`](https://reference.langchain.com/python/langchain-amazon-nova/) integration package.
