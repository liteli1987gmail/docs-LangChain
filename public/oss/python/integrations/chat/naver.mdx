...
4. Issue a Test or Service API key (See [Naver 接口 key documentation](https://api.ncloud-docs.com/docs/ai-naver-clovastudio-summary#API%ED%82%A4).)
...
For detailed documentation of all `ChatClovaX` features and configurations head to the [接口 reference](https://guide.ncloud-docs.com/docs/clovastudio-dev-langchain)
