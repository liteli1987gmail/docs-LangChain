...
UpTrain [[GitHub](https://github.com/uptrain-ai/uptrain) || [网站](https://uptrain.ai/) || [文档](https://docs.uptrain.ai/getting-started/introduction)] 是一个开源平台，用于评估和改进 LLM 应用。它提供 20+ 预配置检查的评分（涵盖语言、代码、embedding 用例），对失败案例进行根本原因分析，并提供解决指导。
