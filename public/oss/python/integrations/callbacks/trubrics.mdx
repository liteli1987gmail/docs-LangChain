...
>[Trubrics](https://trubrics.com) 是一个 LLM 用户分析平台，让你收集、分析和管理用户
prompts & feedback on AI models.

> 查看 [Trubrics 代码仓库](https://github.com/trubrics/trubrics-sdk) 了解更多关于 `Trubrics` 的信息
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\callbacks\trubrics.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
