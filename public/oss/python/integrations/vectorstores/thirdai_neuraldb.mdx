...
> [NeuralDB](https://www.thirdai.com/neuraldb-enterprise/) 是一个由 [ThirdAI](https://www.thirdai.com/) 开发的 CPU 友好且可微调的向量数据库。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\vectorstores\thirdai_neuraldb.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
