...
- [检索 conceptual docs](https://python.langchain.com/docs/concepts/retrieval)
...
- [`CouchbaseSearchVectorStore` 接口 reference](https://couchbase-ecosystem.github.io/langchain-couchbase/langchain_couchbase.html#module-langchain_couchbase.vectorstores.search_vector_store)
- [`CouchbaseQueryVectorStore` 接口 reference](https://couchbase-ecosystem.github.io/langchain-couchbase/langchain_couchbase.html#module-langchain_couchbase.vectorstores.query_vector_store)
