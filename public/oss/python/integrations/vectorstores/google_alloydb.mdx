...
[AlloyDB](https://cloud.google.com/alloydb) 是一个完全托管式关系数据库服务，提供高性能、无缝集成和出色的扩展能力。AlloyDB 与 PostgreSQL 100% 兼容。利用 AlloyDB 的 LangChain 集成，扩展您的数据库应用程序，构建 AI 驱动的体验。
