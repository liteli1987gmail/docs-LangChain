---
title: "Viking DB integration"
description: "Integrate with the Viking DB vector store using LangChain Python."
---

> [viking DB](https://www.volcengine.com/docs/6459/1163946) 是一个用于存储、索引和管理由深度神经网络及其他机器学习(ML)模型生成的大规模嵌入向量的数据库。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\vectorstores\vikingdb.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
