...
[Meilisearch](https://meilisearch.com) 是一个开源、极速且超精准的搜索引擎。它提供了出色的默认配置，帮助开发者构建快速响应的搜索体验。

您可以[自托管 Meilisearch](https://www.meilisearch.com/docs/learn/getting_started/installation#local-installation)或使用 [Meilisearch Cloud](https://www.meilisearch.com/pricing)。
