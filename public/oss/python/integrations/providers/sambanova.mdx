...
If you are a SambaCloud user request an [接口 key](http://cloud.sambanova.ai/apis?utm_source=langchain&utm_medium=external&utm_campaign=cloud_signup) and set it as an environment variable:
...
[SambaNova 接口 Reference](https://docs.sambanova.ai/cloud/api-reference)
