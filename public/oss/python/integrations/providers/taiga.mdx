...
Taiga 是一个开源的项目管理平台，专为敏捷团队设计，提供看板（Kanban）、Scrum 和问题追踪等功能。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\providers\taiga.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
