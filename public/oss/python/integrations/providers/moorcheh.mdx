...
[Moorcheh](https://www.moorcheh.ai/) 是一个极速 semantic search engine 和 vector store。它不使用 L2 或 Cosine 等简单的 distance metrics，而是使用 Maximally Informative Binarization (MIB) 和 Information-Theoretic Score (ITS) 来检索准确的 document chunks。
