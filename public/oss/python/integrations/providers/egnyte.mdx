...
2. **Generate User Token**
   - Use your API key to generate a user token following the [Public 接口 Authentication guide](https://developers.egnyte.com/docs/read/Public_API_Authentication)
