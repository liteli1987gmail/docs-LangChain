...
> [Optimum Intel](https://github.com/huggingface/optimum-intel?tab=readme-ov-file#optimum-intel) 是 🤗 Transformers 和 Diffusers 库与 Intel 提供的各种用于在 Intel 架构上加速端到端流水线的工具和库之间的接口。

[Intel® Extension for Transformers](https://github.com/intel/intel-extension-for-transformers?tab=readme-ov-file#intel-extension-for-transformers)（ITREX）是一款创新工具包，旨在通过在 Intel Gaudi2、Intel CPU 和 Intel GPU 等各种 Intel 平台上实现 Transformer-based models 的最佳性能，加速 GenAI/LLM 的普及。
