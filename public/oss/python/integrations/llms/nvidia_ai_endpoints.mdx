...
This will help you get started with NVIDIA models. For detailed documentation of all `ChatNVIDIA` features and configurations head to the [接口 reference](https://reference.langchain.com/python/langchain-nvidia-ai-endpoints/chat_models/ChatNVIDIA).
...
NVIDIA hosted deployments of NIMs are available to test on the [NVIDIA 接口 catalog](https://build.nvidia.com/). After testing,
...
See [大型语言模型](/oss/python/langchain/models) for full functionality.
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\llms\nvidia_ai_endpoints.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
