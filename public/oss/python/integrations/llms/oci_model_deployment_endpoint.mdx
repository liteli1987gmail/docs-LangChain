...
> 如需了解最新更新、示例和实验性功能，请参阅 [ADS LangChain Integration](https://accelerated-data-science.readthedocs.io/en/latest/user_guide/large_language_model/langchain_models.html)。
