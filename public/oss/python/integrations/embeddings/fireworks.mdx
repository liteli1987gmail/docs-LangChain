...
This will help you get started with Fireworks embedding models using LangChain. For detailed documentation on `FireworksEmbeddings` features and configuration options, please refer to the [接口 reference](https://reference.langchain.com/python/langchain-fireworks/embeddings/FireworksEmbeddings).
...
For detailed documentation of all `FireworksEmbeddings` features and configurations head to the [接口 reference](https://reference.langchain.com/python/langchain-fireworks/embeddings/FireworksEmbeddings).
