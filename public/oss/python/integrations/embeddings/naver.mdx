...
4. Issue a Test or Service API key (see [CLOVA Studio 接口 key guide](https://guide.ncloud-docs.com/docs/clovastudio-explorer-testapp).)
...
- There are several embedding models available in CLOVA Studio. See the [CLOVA Studio embedding 接口 documentation](https://guide.ncloud-docs.com/docs/en/clovastudio-explorer03#임베딩API) for further details.
...
For detailed documentation on `ClovaXEmbeddings` features and configuration options, please refer to the [接口 reference](https://guide.ncloud-docs.com/docs/clovastudio-dev-langchain#%EC%9E%84%EB%B2%A0%EB%94%A9%EB%8F%84%EA%B5%AC%EC%9D%B4%EC%9A%A9).
