...
This will help you get started with Cohere embedding models using LangChain. For detailed documentation on `CohereEmbeddings` features and configuration options, please refer to the [接口 reference](https://reference.langchain.com/python/langchain-cohere/embeddings/CohereEmbeddings).
...
For detailed documentation on `CohereEmbeddings` features and configuration options, please refer to the [接口 reference](https://reference.langchain.com/python/langchain-cohere/embeddings/CohereEmbeddings).
