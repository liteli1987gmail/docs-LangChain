...
This will help you get started with Perplexity embedding models using LangChain. For detailed documentation on `PerplexityEmbeddings` features and configuration options, please refer to the [接口 reference](https://reference.langchain.com/python/langchain-perplexity/embeddings/PerplexityEmbeddings).
...
Available models include `pplx-embed-v1-4b` (default) and `pplx-embed-v1-0.6b`. See the [Perplexity Embeddings 接口 reference](https://docs.perplexity.ai/api-reference/embeddings-post) for the current list and dimensions.
