...
An API key is required to use this embedding model. You can get one by registering at [platform.SparkLLM-ai.com/docs/text-嵌入向量](https://platform.SparkLLM-ai.com/docs/text-Embedding).
