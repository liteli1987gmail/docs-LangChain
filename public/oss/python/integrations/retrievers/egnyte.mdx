...
This will help you get started with the Egnyte [retriever](/oss/python/langchain/retrieval). For detailed documentation of all `EgnyteRetriever` features and configurations head to the [接口 reference](https://github.com/egnyte/egnyte-langchain-connector).
...
2. Generate a user token following the [Public 接口 Authentication guide](https://developers.egnyte.com/docs/read/Public_API_Authentication)
