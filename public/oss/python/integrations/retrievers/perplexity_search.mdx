...
[Perplexity Search](https://docs.perplexity.ai/docs/search/quickstart) 是一个网络搜索 API，返回经过排序的、带来源标注的结果，专为 LLMs 和代理设计。[Search API 端点](https://docs.perplexity.ai/api-reference/search-post) 返回为 Perplexity 回答引擎提供支持的底层网络搜索结果。
