...
[Tavily's Search API](https://tavily.com) 是一个专门为 AI 代理（LLM）打造的搜索引擎，以高速提供实时、准确且可靠的结果。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\python\integrations\retrievers\tavily.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
