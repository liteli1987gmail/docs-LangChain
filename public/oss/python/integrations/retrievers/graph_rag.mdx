...
<Tabs groupId="vector-store" queryString>
    <Tab title="AstraDB">
      ...
      consult the [AstraDB 向量存储 Guide](/oss/python/integrations/vectorstores/astradb).
    ...
    <Tab title="Apache Cassandra">
      ...
      [Apache Cassandra 向量存储 Guide](/oss/python/integrations/vectorstores/cassandra#connection-parameters)
    ...
    <Tab title="OpenSearch">
      ...
      [OpenSearch 向量存储 Guide](/oss/python/integrations/vectorstores/opensearch).
        </div>
    </Tab>
    <Tab title="Chroma">
        <div style={{ paddingLeft: '30px' }}>
      ...
      [Chroma 向量存储 Guide](/oss/python/integrations/vectorstores/chroma).
...
[Graph RAG 接口 reference](https://datastax.github.io/graph-rag/reference/).
