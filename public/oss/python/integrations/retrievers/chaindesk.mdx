...
[Chaindesk 平台](https://docs.chaindesk.ai/introduction) 可将数据从任何地方（Datasources：Text、PDF、Word、PowerPoint、Excel、Notion、Airtable、Google Sheets 等）导入到 Datastores（多个 Datasources 的容器）中。
