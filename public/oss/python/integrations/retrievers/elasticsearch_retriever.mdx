...
[Elasticsearch](https://www.elastic.co/elasticsearch/) 是一个分布式、RESTful 风格的搜索和数据分析引擎。它提供了一个分布式、多租户功能的全文搜索引擎，具有 HTTP Web 接口和无需预设模式的 JSON 文档。它支持关键词搜索、向量搜索、混合搜索和复杂过滤功能。
