    ...
    <Tab title="LangChain" icon="link">
        ...
        <AccordionGroup>
            ...
            <Accordion title="合作伙伴包">
                ...
                许多合作伙伴包位于外部仓库中。请查看[集成列表](/oss/python/integrations/providers/overview)了解更多详情。
...
<Note>
如果你的 PR 包含 AI 生成的内容，你必须遵循我们的[可接受的 LLM 使用](/oss/python/contributing/overview#acceptable-uses-of-llms)政策。看起来是低投入的、AI 生成的垃圾邮件的 PR 将被关闭，恕不另行通知。
</Note>
