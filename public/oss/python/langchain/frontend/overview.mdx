...
<CardGroup cols={3}>
  ...
  <Card title="推理 Token" icon="brain" href="/oss/python/langchain/frontend/reasoning-tokens">
    在可折叠块中显示模型思考过程。
  </Card>
...
<CardGroup cols={3}>
  ...
  <Card title="人在环" icon="user-check" href="/oss/python/langchain/frontend/human-in-the-loop">
...
<CardGroup cols={3}>
  <Card title="加入和重新加入流" icon="plug-connected" href="/oss/python/langchain/frontend/join-rejoin">
