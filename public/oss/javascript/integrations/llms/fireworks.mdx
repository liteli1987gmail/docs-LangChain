...
You may be looking for [this page instead](/oss/javascript/集成s/chat/fireworks/).
</警告>
...
To access Fireworks models you'll need to create a Fireworks account, get an API key, and 安装 `@langchain/community` 集成 包.
...
该 LangChain Fireworks 集成 lives in the `@langchain/community` 包:
