...
You may be looking for [this page instead](/oss/javascript/集成s/chat/mistral/).
</警告>
...
To access MistralAI models you'll need to create a MistralAI account, get an API key, and 安装 `@langchain/mistralai` 集成 包.
...
该 LangChain MistralAI 集成 lives in the `@langchain/mistralai` 包:
