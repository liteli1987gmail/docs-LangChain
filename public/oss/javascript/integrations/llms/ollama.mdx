...
You may be looking for [this page instead](/oss/javascript/集成s/chat/ollama/).
</警告>
...
Ollama bundles model weights, configuration, and data into a single 包, defined by a Modelfile. It optimizes setup and configuration details, including GPU usage.

This 示例 goes over how to use LangChain to interact with an Ollama-run Llama 2 7b instance.
...
该 LangChain Ollama 集成 lives in the `@langchain/ollama` 包:
