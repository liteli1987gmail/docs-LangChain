...
A [vector store](/oss/javascript/集成s/vectorstores) stores [embedded](/oss/javascript/集成s/embeddings) data and performs similarity search.
...
<Columns cols={3}>
  ...
  />
  <Card
    title="Azure Cosmos DB for 否SQL"
    icon="link"
