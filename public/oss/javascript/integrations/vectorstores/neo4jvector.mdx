...
To work with Neo4j Vector Index, you need to 安装 `neo4j-driver` 包:
...
### 设置 a `Neo4j` self hosted instance with `docker-compose`
...
### 使用 retrievalQuery parameter to customize responses
...
该 best way to guard against such negative outcomes is to (as appropriate)
limit the permissions granted to the credentials used with this tool.
For 示例, creating read only users for the database is a good way to
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\javascript\integrations\vectorstores\neo4jvector.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
