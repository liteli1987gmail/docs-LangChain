...
A vector index can significantly speed up top-k nearest neighbor queries for vectors. 使用rs can create a Hierarchical Navigable Small World (HNSW) vector index using the `create_hnsw_index` function.
