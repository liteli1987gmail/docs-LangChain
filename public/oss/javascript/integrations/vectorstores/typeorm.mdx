...
To work with TypeORM, you need to 安装 `typeorm` and `pg` 包s:
...
### 设置 a `pgvector` self hosted instance with `docker-compose`
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\javascript\integrations\vectorstores\typeorm.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
