...
请参阅 a [usage 示例](/oss/javascript/集成s/chat/azure)
...
```
请参阅 a [usage 示例](/oss/javascript/集成s/llms/azure).
...
请参阅 a [usage 示例](/oss/javascript/集成s/embeddings/azure_openai)
...
```
请参阅 a [usage 示例](/oss/javascript/集成s/vectorstores/azure_aisearch).

```typescript
import { AzureAISearchVectorStore } from "@langchain/community/vectorstores/azure_aisearch";
```
### Azure cosmos DB for 否SQL
...
```
请参阅 a [usage 示例](/oss/javascript/集成s/vectorstores/azure_cosmosdb_nosql).
...
npm install @langchain/azure-cosmosdb @langchain/core
```
请参阅 a [usage 示例](/oss/javascript/集成s/vectorstores/azure_documentdb).
...
### Azure cosmos DB 否SQL Semantic cache
...
npm install @langchain/azure-cosmosdb @langchain/core
```
请参阅 a [usage 示例](/oss/javascript/集成s/llm_caching/azure_cosmosdb_nosql).
...
```
请参阅 a [usage 示例 for the Azure Blob Storage](/oss/javascript/集成s/document_loaders/web_loaders/azure_blob_storage_container).

```typescript
import { AzureBlobStorageContainerLoader } from "@langchain/community/document_loaders/web/azure_blob_storage_container";
```
请参阅 a [usage 示例 for the Azure Files](/oss/javascript/集成s/document_loaders/web_loaders/azure_blob_storage_file).
...
```
请参阅 a [usage 示例](/oss/javascript/集成s/tools/azure_dynamic_sessions).
