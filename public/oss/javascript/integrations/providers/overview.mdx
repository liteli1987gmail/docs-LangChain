---
title: "LangChain JavaScript 集成s"
sidebarTitle: 概述
mode: wide
...
A **provider** is a third-party service or platform that LangChain integrates with to access AI capabilities like chat models, embeddings, and vector stores. 该se providers have standalone `langchain-provider` 包s for improved versioning, dependency management, and testing.

## Popular providers

| Provider | 包 | 下载量 | Latest |
| :------- | :------ | :-------- | :------|
...
请参阅 [all providers](/oss/javascript/集成s/providers/all_providers) or search for a provider using the search field.
