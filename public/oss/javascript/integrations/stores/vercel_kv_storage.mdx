...
This 示例 demonstrates how to setup chat history storage using the `VercelKVStore` [`BaseStore`](https://reference.langchain.com/javascript/langchain-core/stores/BaseStore) 集成.
