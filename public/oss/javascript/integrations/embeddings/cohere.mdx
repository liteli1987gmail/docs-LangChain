---
title: "Cohere嵌入 集成"
description: "Integrate with the Cohere嵌入 embedding model using LangChain JavaScript."
---
...
To access Cohere embedding models you'll need to create a Cohere account, get an API key, and 安装 `@langchain/cohere` 集成 包.
...
该 LangChain Cohere嵌入 集成 lives in the `@langchain/cohere` 包:
