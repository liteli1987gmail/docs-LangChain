---
title: "TogetherAI嵌入 集成"
description: "Integrate with the TogetherAI嵌入 embedding model using LangChain JavaScript."
---
...
To access TogetherAI embedding models you'll need to create a TogetherAI account, get an API key, and 安装 `@langchain/community` 集成 包.
...
该 LangChain TogetherAI嵌入 集成 lives in the `@langchain/community` 包:
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\javascript\integrations\embeddings\togetherai.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
