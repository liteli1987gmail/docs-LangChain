---
title: "Fireworks嵌入 集成"
description: "Integrate with the Fireworks嵌入 embedding model using LangChain JavaScript."
---
...
To access Fireworks embedding models you'll need to create a Fireworks account, get an API key, and 安装 `@langchain/community` 集成 包.
...
该 LangChain `Fireworks嵌入` 集成 lives in the `@langchain/community` 包:
