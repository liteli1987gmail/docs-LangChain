...
To 安装 `@langchain/mixedbread-ai` 包, use the following command:
...
You can pass the API key directly to the constructor or 将其设置为环境变量 (`MXBAI_API_KEY`).

### Basic usage

Here’s how to create an instance of `MixedbreadAI嵌入`:
