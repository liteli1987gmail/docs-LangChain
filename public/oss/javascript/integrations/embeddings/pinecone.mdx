---
title: "Pinecone嵌入 集成"
description: "Integrate with the Pinecone嵌入 embedding model using LangChain JavaScript."
---
...
To access Pinecone embedding models you'll need to create a Pinecone account, get an API key, and 安装 `@langchain/pinecone` 集成 包.
...
该 LangChain Pinecone嵌入 集成 lives in the `@langchain/pinecone` 包:
