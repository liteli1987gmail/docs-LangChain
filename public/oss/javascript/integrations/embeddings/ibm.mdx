...
To access IBM WatsonxAI embeddings you'll need to create an IBM watsonx.ai account, get an API key or any other type of credentials, and 安装 `@langchain/community` 集成 包.
...
该 LangChain IBM watsonx.ai 集成 lives in the `@langchain/community` 包:
...
详细文档请参阅 of all __module_name__ features and configurations head to the API 参考: __api_ref_module__
