---
title: "ByteDanceDoubao嵌入 集成"
description: "Integrate with the ByteDanceDoubao嵌入 embedding model using LangChain JavaScript."
---
...
该 LangChain ByteDanceDoubao嵌入 集成 lives in the `@langchain/community` 包:
