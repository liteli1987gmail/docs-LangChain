---
title: "GoogleGenerativeAI嵌入 集成"
sidebarTitle: "嵌入"
description: "Integrate with the GoogleGenerativeAI嵌入 embedding model using LangChain JavaScript."
---
...
To access Google Generative AI embedding models you'll need to 注册 for a Google AI account, get an API key, and 安装 `@langchain/google-genai` 集成 包.
...
该 LangChain `GoogleGenerativeAI嵌入` 集成 lives in the `@langchain/google-genai` 包. You may also wish to 安装 official SDK:
