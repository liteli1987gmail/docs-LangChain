...
该 Gmail Tool allows your agent to create and view messages from a linked email account.
...
2. You will need to get an API key from [Google here](https://developers.google.com/gmail/api/guides)
   ...
   该n, set the environment variables for `GMAIL_CLIENT_EMAIL`, and either `GMAIL_PRIVATE_KEY`, or `GMAIL_KEYFILE`.

To use the Gmail Tool you need to 安装 following official peer dependency:
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\javascript\integrations\tools\google_gmail.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
