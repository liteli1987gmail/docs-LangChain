...
instructions on deploying and configuring, 请参阅 the official Toolbox
documentation:
...
LangChain relies on the `@toolbox-sdk/core` node 包 to use Toolbox. Install the
包 before getting started:
...
更多信息请参阅, read more about the following:
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss\javascript\integrations\tools\mcp_toolbox.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
