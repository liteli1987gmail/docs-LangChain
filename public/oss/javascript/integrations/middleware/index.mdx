...
<CardGroup cols={2}>
    <Card title="Add an official 集成" icon="包" href="/oss/javascript/contributing/implement-langchain#middleware">
...
|------------|-------------|
| [Anthropic](/oss/javascript/集成s/middleware/anthropic) | 提示缓存 |
