...
For setup details of the SAP HANA vector store, 请参阅 the guide at [Vector Store: SAP HANA](/oss/javascript/集成s/vectorstores/sap_hanavector).
...
否w for the main act: here is how to construct a SelfQueryRetriever for HANA vectorstore:
