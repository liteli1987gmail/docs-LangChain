...
This guide will also use [OpenAI embeddings](/oss/集成s/embeddings/openai), which require you to 安装 `@langchain/openai` 集成 包. You can also use [other supported embeddings models](/oss/集成s/embeddings) if you wish.
