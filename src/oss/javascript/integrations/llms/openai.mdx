...
Unless you are specifically using `gpt-3.5-turbo-instruct`, you are probably looking for [this page instead](/oss/集成s/chat/openai/).
</Warning>
...
If you are hosting on Azure OpenAI, 请参阅 the [dedicated page instead](/oss/集成s/llms/azure).
