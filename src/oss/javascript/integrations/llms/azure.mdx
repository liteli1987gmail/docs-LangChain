...
Unless you are specifically using `gpt-3.5-turbo-instruct`, you are probably looking for [this page instead](/oss/集成s/chat/azure/).
</Warning>
...
2. Update your imports to use the new `AzureOpenAI` and @[`AzureChatOpenAI`] classes from the `@langchain/openai` 包:
