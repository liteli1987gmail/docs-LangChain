...
This will help you get started with the Slack [toolkit](/oss/integrations/tools/slack). For detailed documentation of all `SlackToolkit` features and configurations head to the [接口 reference](https://reference.langchain.com/python/langchain-community/agent_toolkits/slack/toolkit/SlackToolkit).
