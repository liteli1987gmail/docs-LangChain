...
Sign up for Mathpix and [create an 接口 key](https://mathpix.com/docs/ocr/creating-an-api-key) to set the `MATHPIX_API_KEY` variables in your environment
...
For detailed documentation of all `MathpixPDFLoader` features and configurations head to the [接口 reference](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/MathpixPDFLoader)
