...
>[Microsoft PowerPoint](https://en.wikipedia.org/wiki/Microsoft_PowerPoint) 是微软的一个演示程序。
...
[Azure AI Document Intelligence](https://aka.ms/doc-intelligence)（原名为 `Azure Form Recognizer`）是一款基于机器学习的服务，能够从数字化或扫描的 PDF、图片、Office 文件和 HTML 文件中提取文本（包括手写内容）、表格、文档结构（如标题、章节标题等）以及键值对。
