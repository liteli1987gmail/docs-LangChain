...
The `AssemblyAIAudioTranscriptLoader` allows to transcribe audio files with the [AssemblyAI 接口](https://www.assemblyai.com) and loads the transcribed text into documents.
...
- [Get a Free 接口 key](https://www.assemblyai.com/dashboard/signup)
- [AssemblyAI 接口 Docs](https://www.assemblyai.com/docs)
...
Visit the [AssemblyAI 接口 Documentation](https://www.assemblyai.com/docs) to get an overview of all available models!
