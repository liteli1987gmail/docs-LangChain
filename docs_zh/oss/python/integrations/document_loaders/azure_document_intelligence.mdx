...
[Azure AI Document Intelligence](https://aka.ms/doc-intelligence)（原名 `Azure Form Recognizer`）是一款基于机器学习的服务，可从数字化或扫描的 PDF、图片、Office 和 HTML 文件中提取文本（包括手写内容）、表格、文档结构（如标题、章节标题等）和键值对。
