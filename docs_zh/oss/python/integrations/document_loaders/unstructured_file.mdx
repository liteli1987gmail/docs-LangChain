...
your `api_key` and set `partition_via_api=True`. You can [generate a free Unstructured 接口 key](https://unstructured.io/api-key/).

Check out the [Docker image instructions for self-hosting the Unstructured 接口](https://github.com/Unstructured-IO/unstructured-api#dizzy-instructions-for-using-the-docker-image)
...
For detailed documentation of all `UnstructuredLoader` features and configurations head to the [接口 reference](https://reference.langchain.com/python/langchain-unstructured/document_loaders/UnstructuredLoader)
