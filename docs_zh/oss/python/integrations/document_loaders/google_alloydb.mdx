...
[AlloyDB](https://cloud.google.com/alloydb) 是一项完全托管的关系型数据库服务，提供高性能、无缝集成和出色的可扩展性。AlloyDB 与 PostgreSQL 100% 兼容。利用 AlloyDB 的 LangChain 集成扩展您的数据库应用程序，构建 AI 驱动的体验。
