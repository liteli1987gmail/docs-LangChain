...
Certain models can generate text and images inline. See [Gemini 接口 docs](https://ai.google.dev/gemini-api/docs/image-generation) for details.
...
Certain models can generate audio files. See [Gemini 接口 docs](https://ai.google.dev/gemini-api/docs/speech-generation) for details.
...
Force the model to respond with a specific structure. See the [Gemini 接口 docs](https://ai.google.dev/gemini-api/docs/structured-output) for more info.
...
See the [Gemini 接口 docs](https://ai.google.dev/gemini-api/docs/thinking) for more information on thinking.
...
<Warning>
    **Preview model limitations**
    ...
    The Computer Use model is in preview and may produce unexpected behavior. Always supervise automated tasks and avoid use with sensitive data or critical operations. See the [Gemini 接口 docs](https://ai.google.dev/gemini-api/docs/computer-use) for safety best practices.
</Warning>
