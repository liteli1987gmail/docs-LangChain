...
<Info>
    **Google Cloud VertexAI vs Gemini API**
    ...
    The Google Cloud VertexAI integration is separate from the [Google Gemini 接口](/oss/integrations/chat/google_generative_ai/). This page showcases an enterprise version of Gemini through Google Cloud Platform (GCP).
</Info>
