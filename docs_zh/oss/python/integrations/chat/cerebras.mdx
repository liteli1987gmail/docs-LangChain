...
This guide provides a quick overview for getting started with Cerebras [chat models](/oss/langchain/models). For detailed documentation of all `ChatCerebras` features and configurations head to the [接口 reference](https://reference.langchain.com/python/langchain-cerebras/chat_models/ChatCerebras).
