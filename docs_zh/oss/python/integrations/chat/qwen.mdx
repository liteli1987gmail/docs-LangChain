...
This will help you get started with Qwen [chat models](/oss/langchain/models). For detailed documentation of all `ChatQwen` features and configurations head to the [接口 reference](https://pypi.org/project/langchain-qwq/).
