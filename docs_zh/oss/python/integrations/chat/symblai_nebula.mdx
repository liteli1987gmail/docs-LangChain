...
Head to the [接口 reference](https://docs.symbl.ai/reference/nebula-chat) for detailed documentation.
...
To get started, request a [Nebula 接口 key](https://platform.symbl.ai/#/login) and set the `NEBULA_API_KEY` environment variable:
