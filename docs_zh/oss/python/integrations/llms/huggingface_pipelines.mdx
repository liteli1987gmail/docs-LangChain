...
For more information refer to [OpenVINO 大型语言模型 guide](https://docs.openvino.ai/2024/learn-openvino/llm_inference_guide.html) and [OpenVINO Local Pipelines notebook](/oss/integrations/llms/openvino/).
