...
To run this notebook, you'll need a [Minimax account](https://api.minimax.chat), an [接口 key](https://api.minimax.chat/user-center/basic-information/interface-key), and a [Group ID](https://api.minimax.chat/user-center/basic-information)
