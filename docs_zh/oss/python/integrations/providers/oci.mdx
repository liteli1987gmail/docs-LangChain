...
> [OCI Data Science](https://docs.oracle.com/en-us/iaas/data-science/using/home.htm) 是一个面向数据科学团队的完全托管式无服务器平台。使用 [OCI Data Science Model Deployment Service](https://docs.oracle.com/en-us/iaas/data-science/using/model-dep-about.htm) 将自定义模型部署为端点。
