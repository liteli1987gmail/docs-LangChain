...
Get an OpenAI API key from the [OpenAI 接口 keys page](https://platform.openai.com/account/api-keys). By running the following code, you will be asked to provide your API key.
