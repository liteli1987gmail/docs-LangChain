...
To use xAI, you'll need to [create an 接口 key](https://console.x.ai/). The API key can be passed in as an init param `xai_api_key` or set as environment variable `XAI_API_KEY`.
