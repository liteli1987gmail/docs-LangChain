...
[Fleet AI Context](https://www.fleet.so/context) 是一个高质量嵌入向量数据集，收录了最受欢迎且最开放的前1200个 Python 库及其文档。

Fleet AI 团队的使命是将世界上最重要的数据进行嵌入。他们从嵌入前1200个 Python 库开始，以实现具有最新知识的代码生成。
