...
For detailed documentation, head to the @[`ParallelSearchRetriever`] API reference or the [Parallel Search 接口 guides](https://docs.parallel.ai/search/search-quickstart).
