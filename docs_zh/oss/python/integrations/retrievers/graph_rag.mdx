...
<Tabs groupId="vector-store" queryString>
    <Tab title="AstraDB">
      ...
      consult the [AstraDB 向量存储 Guide](/oss/integrations/vectorstores/astradb).
    ...
    <Tab title="Apache Cassandra">
      ...
      [Apache Cassandra 向量存储 Guide](/oss/integrations/vectorstores/cassandra#connection-parameters)
    ...
    <Tab title="OpenSearch">
      ...
      [OpenSearch 向量存储 Guide](/oss/integrations/vectorstores/opensearch).
        </div>
    </Tab>
    <Tab title="Chroma">
        <div style={{ paddingLeft: '30px' }}>
      ...
      [Chroma 向量存储 Guide](/oss/integrations/vectorstores/chroma).
