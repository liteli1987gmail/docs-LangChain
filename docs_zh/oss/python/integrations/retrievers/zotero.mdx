...
| :--- | :--- | :---: |
[ZoteroRetriever](https://github.com/TimBMK/langchain-zotero-retriever) | [Zotero 接口](https://www.zotero.org/support/dev/web_api/v3/start) | langchain-community |
...
For detailed documentation on the Zotero API, head to the [Zotero 接口 reference](https://www.zotero.org/support/dev/web_api/v3/start).
