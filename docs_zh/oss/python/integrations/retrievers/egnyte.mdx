...
This will help you get started with the Egnyte [retriever](/oss/langchain/retrieval). For detailed documentation of all `EgnyteRetriever` features and configurations head to the [接口 reference](https://github.com/egnyte/egnyte-langchain-connector).
