...
For detailed documentation of all `OCIGenAIEmbeddings` features and configurations, head to the [接口 reference](https://github.com/oracle/langchain-oracle/tree/main/libs/oci).
