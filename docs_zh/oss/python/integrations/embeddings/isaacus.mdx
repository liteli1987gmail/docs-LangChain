...
After adding a payment method, [create a new 接口 key](https://platform.isaacus.com/users/api-keys/).
...
We're going to use [Kanon 2 Embedder](https://isaacus.com/blog/introducing-kanon-2-embedder), the world's most accurate legal embedding model on the [Massive Legal 嵌入向量 Benchmark](https://isaacus.com/blog/introducing-mleb) as of 20 October 2025.
