...
[Chroma](https://docs.trychroma.com/getting-started) 是一个 AI 原生的开源向量数据库，专注于开发者的工作效率和幸福感。Chroma 采用 Apache 2.0 许可证。在[此页面](https://docs.trychroma.com/reference/py-collection)查看 Chroma 的完整文档，并在[此页面](https://reference.langchain.com/python/langchain-chroma/vectorstores/Chroma)查找 LangChain 集成的 API 参考。
