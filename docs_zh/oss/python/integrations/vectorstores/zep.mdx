...
从对话历史中召回、理解并提取数据，为个性化 AI 体验赋能。


[Zep](https://www.getzep.com) 是一款面向 AI Assistant 应用的长效记忆服务。借助 Zep，你可以让 AI 助手具备回忆任意时间点过去对话的能力，同时还能减少幻觉、延迟和成本。

想要了解更多 Zep Cloud？请参考 [Zep Cloud 安装指南](https://help.getzep.com/sdks) 和 [Zep Cloud Vector Store 示例](https://help.getzep.com/langchain/examples/vectorstore-example)。
...
Zep 是一个开源的 LLM 应用内存平台，可帮助开发者构建具有长期记忆的对话式 AI 应用。
