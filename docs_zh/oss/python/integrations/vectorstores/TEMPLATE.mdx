...
This guide provides a quick overview for getting started with the (MODULE_NAME) [vector store](/oss/integrations/vectorstores#overview). For a detailed listing of all (MODULE_NAME)VectorStore features, paramaters, and configurations, head to the [(MODULE_NAME)VectorStore 接口 reference](<LINK>).
...
For detailed documentation of all (MODULE_NAME)VectorStore features and configurations, head to the [接口 reference](<LINK>).
