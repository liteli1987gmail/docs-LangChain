...
这份使用 LangGraph 的公司及其成功案例列表来自公开来源。如果您的公司使用 LangGraph，我们非常希望您分享您的故事并将其添加到列表中。我们也欢迎您根据其他公司的公开信息（如博客文章或新闻稿）贡献更新。

| 公司 | 行业 | 用例 | 参考资料 |
| --- | --- | --- | --- |
| [AirTop](https://www.airtop.ai/) | 软件与技术（GenAI 原生） | 代理的浏览器自动化 | [案例研究，2024](https://blog.langchain.dev/customers-airtop/) |
...
| [Komodo Health](https://www.komodohealth.com/) | 医疗 | 领域特定任务的 Copilot | [博客文章](https://www.komodohealth.com/perspectives/new-gen-ai-assistant-empowers-the-enterprise/) |
...
| [OpenRecovery](https://www.openrecovery.com/) | 医疗 | 领域特定任务的 Copilot | [案例研究，2024](https://blog.langchain.dev/customers-openrecovery/) |
...
| [Replit](https://replit.com/) | 软件与技术 | 代码生成 | [博客文章，2024](https://blog.langchain.dev/customers-replit/)；[Breakout 代理故事，2024](https://www.langchain.com/breakoutagents/replit)；[炉边对话视频，2024](https://www.youtube.com/watch?v=ViykMqljjxU) |
...
| [Vizient](https://www.vizientinc.com/) | 医疗 | 领域特定任务的 Copilot | [视频故事，2025](https://www.youtube.com/watch?v=vrjJ6NuyTWA)；[案例研究，2025](https://blog.langchain.dev/p/3d2cd58c-13a5-4df9-bd84-7d54ed0ed82c/) |
