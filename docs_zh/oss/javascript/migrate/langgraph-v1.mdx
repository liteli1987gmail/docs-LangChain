...
This guide outlines changes in LangGraph v1 and how to migrate from previous versions. For a high-level overview of what's new, 请参阅 the [release notes](/oss/releases/langgraph-v1).
...
请参阅 [Interrupts](/oss/langgraph/interrupts) to learn more.
