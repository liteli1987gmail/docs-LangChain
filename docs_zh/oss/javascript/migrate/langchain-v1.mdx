...
This migration guide outlines the major changes in LangChain v1. To learn more about the new features of v1, 请参阅 the [introductory post](/oss/releases/langchain-v1).
...
请参阅 the content blocks [reference](/oss/langchain/messages#content-block-reference) for more details.
...
<否te>
    Learn more: [Messages](/oss/langchain/messages#message-content) and [Standard content blocks](/oss/langchain/messages#standard-content-blocks). 请参阅 [Multimodal](/oss/langchain/messages#multimodal) for input 示例s.
</否te>
