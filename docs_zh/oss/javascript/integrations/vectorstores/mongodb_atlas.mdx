...
In **manual embedding mode**, you provide an embeddings model and embed documents client-side. This guide uses [OpenAI embeddings](/oss/集成s/embeddings/openai) as an 示例. You can also use [other supported embeddings models](/oss/集成s/embeddings).
