...
本指南将帮助您开始使用 `ChatCohere` [聊天模型](/oss/langchain/models)。有关所有 `ChatCohere` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-cohere/ChatCohere)。
