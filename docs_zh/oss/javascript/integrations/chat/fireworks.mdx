...
[Fireworks AI](https://fireworks.ai/) 是一个 AI 推理平台，用于运行和自定义模型。有关 Fireworks 提供所有模型的列表，请参阅 [Fireworks 文档](https://fireworks.ai/models)。

本指南将帮助您开始使用 `ChatFireworks` [聊天模型](/oss/langchain/models)。有关所有 `ChatFireworks` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-community/chat_models/fireworks/ChatFireworks)。
