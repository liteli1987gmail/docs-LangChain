...
To access Cohere models you'll need to create a Cohere account, get an API key, and 安装 `@langchain/cohere` 集成 包.
...
该 LangChain Cohere 集成 lives in the `@langchain/cohere` 包:
