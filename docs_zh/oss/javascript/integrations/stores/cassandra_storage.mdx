...
This 示例 demonstrates how to setup chat history storage using the `CassandraKVStore` @[`BaseStore`] 集成. 否te there is a `CassandraChatMessageHistory`
...
- [Key-value store 概念指南](/oss/集成s/stores)
