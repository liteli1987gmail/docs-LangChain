...
LangSmith 可以使用其内置的 OpenTelemetry 支持来捕获由 [Semantic Kernel](https://learn.microsoft.com/en-us/semantic-kernel/overview/) 生成的追踪。本指南向您展示如何自动捕获 Semantic Kernel 应用程序中的追踪，并将其发送到 LangSmith 进行监控和分析。
