...
本指南假设您了解什么是双重消息，您可以在[双重消息概念指南](/langsmith/double-texting)中了解。

本指南涵盖双重消息的 `enqueue` 选项，该选项将中断添加到队列中并按客户端接收的顺序执行它们。以下是使用 `enqueue` 选项的快速示例。

入队是在 [Agent Server](/langsmith/agent-server) 中创建运行时默认的双重消息（多任务）策略。
...
然后，让我们导入所需的包并实例化我们的 client、assistant 和 thread。
...
现在让我们启动两个运行，第二个运行以"入队"多任务策略中断第一个：
...
[{"url": "https://www.weatherapi.com/", "content": "{'location': {'name': 'New York', 'region': 'New York', 'country': 'United States of America', 'lat': 40.71, 'lon': -74.01, 'tz_id': 'America/New_York', 'localtime_epoch': 1718734479, 'localtime': '2024-06-18 14:14'}, 'current': {'last_updated_epoch': 1718733600, 'last_updated': '2024-06-18 14:00', 'temp_c': 29.4, 'temp_f': 84.9, 'is_day': 1, 'condition': {'text': 'Sunny', 'icon': '//cdn.weatherapi.com/weather/64x64/day/113.png', 'code': 1000}, 'wind_mph': 2.2, 'wind_kph': 3.6, 'wind_degree': 158, 'wind_dir': 'SSE', 'pressure_mb': 1025.0, 'pressure_in': 30.26, 'precip_mm': 0.0, 'precip_in': 0.0, 'humidity': 63, 'cloud': 0, 'feelslike_c': 31.3, 'feelslike_f': 85.3, 'windchill_c': 28.3, 'windchill_f': 82.9, 'heatindex_c': 29.6, 'heatindex_f': 85.3, 'dewpoint_c': 18.4, 'dewpoint_f': 65.2, 'vis_km': 16.0, 'vis_miles': 9.0, 'uv': 7.0, 'gust_mph': 16.5, 'gust_kph': 26.5}}"]
================================= Ai Message ==================================
