---
title: 追踪 CrewAI 应用程序
sidebarTitle: CrewAI
---

LangSmith 可以使用 OpenTelemetry 检测来捕获由 [CrewAI](https://github.com/crewAIInc/crewAI) 生成的追踪。本指南向您展示如何自动捕获 CrewAI 多智能体工作流中的追踪，并将其发送到 LangSmith 进行监控和分析。
...
配置完成后，您的 CrewAI 应用程序将自动向 LangSmith 发送追踪：
