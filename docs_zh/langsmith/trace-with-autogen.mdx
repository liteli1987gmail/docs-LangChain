---
title: 追踪 AutoGen 应用程序
sidebarTitle: AutoGen
---

LangSmith 可以使用 OpenTelemetry 检测捕获由 [AutoGen](https://microsoft.github.io/autogen/stable/) 生成的追踪。本指南向您展示如何从您的 AutoGen 多智能体对话自动捕获追踪并将其发送到 LangSmith 进行监控和分析。
...
配置完成后，您的 AutoGen 应用程序将自动向 LangSmith 发送追踪。将追踪器提供程序传递给运行时以获得完整追踪覆盖：
...
您可以将 AutoGen 追踪与其他 OpenTelemetry 检测器结合：
